...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND indexname = 'uq_crm_deals_account_conversation_id'
      AND tablename = 'crm_deals'
  ) THEN
    CREATE UNIQUE INDEX uq_crm_deals_account_conversation_id
...
BEGIN
  IF NOT EXISTS (
    ...
    FROM pg_indexes
    WHERE schemaname = 'public'
      AND indexname = 'idx_crm_deals_account_contact_id'
      AND tablename = 'crm_deals'
  ) THEN
    CREATE INDEX idx_crm_deals_account_contact_id
